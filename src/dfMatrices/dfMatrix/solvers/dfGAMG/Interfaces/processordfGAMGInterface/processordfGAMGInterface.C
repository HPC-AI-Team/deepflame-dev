...
namespace Foam
{
    defineTypeNameAndDebug(processordfGAMGInterface, 0);
    addToRunTimeSelectionTable
    (
        dfGAMGInterface,
        processordfGAMGInterface,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processordfGAMGInterface::processordfGAMGInterface
(
    const label index,
...
void Foam::processordfGAMGInterface::initInternalFieldTransfer
(
...
Foam::tmp<Foam::labelField> Foam::processordfGAMGInterface::internalFieldTransfer
(
    const Pstream::commsTypes commsType,
    const labelUList& iF
) const
...
void Foam::processordfGAMGInterface::write(Ostream& os) const
{
