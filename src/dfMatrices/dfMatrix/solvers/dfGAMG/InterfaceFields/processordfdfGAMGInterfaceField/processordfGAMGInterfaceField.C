...
namespace Foam
{
    defineTypeNameAndDebug(processordfGAMGInterfaceField, 0);
    addToRunTimeSelectionTable
    (
        dfGAMGInterfaceField,
        processordfGAMGInterfaceField,
        lduInterface
    );
    addToRunTimeSelectionTable
    (
...
Foam::processordfGAMGInterfaceField::processordfGAMGInterfaceField
(
...
:
    ...
    procInterface_(refCast<const processordfGAMGInterface>(GAMGCp)),
    doTransform_(false),
    rank_(0)
{
...
void Foam::processordfGAMGInterfaceField::initInterfaceMatrixUpdate
(
    scalarField&,
...
) const
{
    ...
    const_cast<processordfGAMGInterfaceField&>(*this).updatedMatrix() = false;
}


void Foam::processordfGAMGInterfaceField::updateInterfaceMatrix
(
    scalarField& result,
    const scalarField&,
...
) const
{
    ...
    )
    {
        ...
        // Recv finished so assume sending finished as wdf.
    ...
    const_cast<processordfGAMGInterfaceField&>(*this).updatedMatrix() = true;
}
